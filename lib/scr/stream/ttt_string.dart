...
extension TttStringExt on TttStream<String> {
...
extension TttNullableStringExt on TttStream<String?> {
  String operator +(String val) => (value ?? '') + val;
...
/// TttStream class for `String` Type.
class TttString extends TttStream<String>
    implements Comparable<String>, Pattern {
  TttString(super.initial);
...
/// TttStream class for `String` Type.
class TttNullableString extends TttStream<String?>
    implements Comparable<String>, Pattern {
  TttNullableString([super.initial]);
